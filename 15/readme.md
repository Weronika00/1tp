...
## Abstract 
The project results in a web application for a pack delivery company, it makes it possible to track a pack's location as well. The courier can view any pack and by inputting it's ID he can view where it is supposed to go, where it was sent from and where it is.
...
> I am personally responsible for its operation: Radosław Ottka.
