...
## Abstract 
The program is to have the current gps data of the device. When you enter the device name, the program shows the current gps data.
...
> I am personally responsible for its operation: Bartosz Brandt.
...
[Wireframe the main form][wireframeMain]
 ...
 [erd]: https://github.com/Michal3456/1tp/blob/main/2/sprites/erd.png

 [osd]: https://github.com/Michal3456/1tp/blob/main/2/sprites/fsa.drawio.png
